#!/usr/bin/env node
/**
 * Generates extension bridge files based on clawdock-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'clawdock-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure clawdock-extensions.json and link the package.',
