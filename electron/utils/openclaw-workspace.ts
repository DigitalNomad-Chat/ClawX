...
/**
 * ClawDock alias for the default identity seeding routine.
 * Keeps the desktop boot path free of OpenClaw's chat-first bootstrap.
 */
export const ensureClawDockDefaultIdentity = ensureClawXDefaultIdentity;
