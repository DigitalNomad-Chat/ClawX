/**
 * v0.4.9 P2 — HostApiRegistry + host:invoke dispatcher (dual-path with legacy IPC).
 * Selective adapter from upstream 581981f2.
 */
...
export class HostApiRegistry {
  ...
  registerExtensionContributions(
    extensionId: string,
    contributions: HostApiContribution[],
  ): () => void {
...
export function createHostInvokeDispatcher(
