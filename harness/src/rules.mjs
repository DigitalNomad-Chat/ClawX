...
const LOCALHOST_FALLBACK_FLAG = 'clawdock:allow-localhost-fallback';
const SSE_FALLBACK_FLAG = 'clawdock:allow-sse-fallback';
const WS_DIAGNOSTIC_FLAG = 'clawdock:gateway-ws-diagnostic';
