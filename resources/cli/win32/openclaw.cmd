...
if /i "%1"=="update" (
    echo openclaw is managed by ClawDock ^(bundled version^).
    echo.
    echo To update openclaw, update ClawDock:
    echo   Open ClawDock ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=ClawDock
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\ClawDock.exe" "%OPENCLAW_ENTRY%" %*
)
