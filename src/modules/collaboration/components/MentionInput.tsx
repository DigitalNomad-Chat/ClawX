  ...
  return (
    <div className="relative flex-1 min-w-0">
      <Textarea
        ref={textareaRef}
        aria-label="消息输入框"
        className="min-h-[44px] w-full resize-none rounded-lg border border-border bg-card px-3 py-2 text-sm shadow-sm transition-[height] duration-200 ease-out placeholder:text-muted-foreground/60 hover:border-border/80 focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
