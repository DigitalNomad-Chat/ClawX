...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'openrouter', name: 'OpenRouter', icon: '🌐', placeholder: 'sk-or-v1-...', model: 'Multi-Model', requiresApiKey: true, showModelId: true, modelIdPlaceholder: 'openai/gpt-5.5', defaultModelId: 'openai/gpt-5.5', docsUrl: 'https://openrouter.ai/models' },
  {
    ...
    modelIdPlaceholder: 'doubao-1-5-pro-32k-250115',
  ...
  { id: 'xai', name: 'xAI (Grok)', icon: 'X', placeholder: 'xai-...', model: 'Grok', requiresApiKey: true, defaultBaseUrl: 'https://api.x.ai/v1', defaultModelId: 'grok-4', showModelId: true, showModelIdInDevModeOnly: true, modelIdPlaceholder: 'grok-4', apiKeyUrl: 'https://console.x.ai/' },
  { id: 'mistral', name: 'Mistral AI', icon: '🌬️', placeholder: 'mistral-...', model: 'Mistral', requiresApiKey: true, defaultBaseUrl: 'https://api.mistral.ai/v1', defaultModelId: 'mistral-large-latest', showModelId: true, showModelIdInDevModeOnly: true, modelIdPlaceholder: 'mistral-large-latest', apiKeyUrl: 'https://console.mistral.ai/' },
