...
import { AlertCircle, Bot, Check, Plus, RefreshCw, Settings2, Trash2, X, Users } from 'lucide-react';
...
export function Agents() {
  ...
  return (
    <div data-testid="agents-page" className="flex h-full flex-col gap-6">
      {/* Header */}
...
function AgentCard({
  ...
  return (
    <div
      className={cn(
        'group flex items-start gap-4 p-5 rounded-xl border bg-card transition-all cursor-pointer',
        'hover:shadow-md hover:border-primary/30',
        agent.isDefault && 'bg-card'
      )}
    >
...
function AddAgentDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md rounded-xl border shadow-lg bg-card overflow-hidden">
        ...
        <CardContent className="space-y-6 pt-4 p-6">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-foreground/60">{t('createDialog.inheritWorkspaceDescription')}</p>
            </div>
            <Switch
...
function AgentSettingsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl max-h-[90vh] flex flex-col rounded-xl border shadow-lg bg-card overflow-hidden">
        ...
        <CardContent className="space-y-6 pt-4 overflow-y-auto flex-1 p-6">
          <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                {!agent.isDefault && (
                  <Button
                    ...
                    className="h-[44px] text-sm font-medium rounded-xl px-4 border bg-surface-input hover:bg-muted shadow-none text-foreground/80 hover:text-foreground"
                  >
                    {savingName ? (
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1 rounded-xl bg-muted border p-4">
              ...
              <button
                ...
                className="space-y-1 rounded-xl bg-muted border p-4 text-left hover:bg-muted/80 transition-colors"
              >
                <p className="text-xs uppercase tracking-[0.08em] text-muted-foreground/80 font-medium">
            ...
            {assignedChannels.length === 0 && agent.channelTypes.length === 0 ? (
              ...
              <div className="space-y-3">
                {assignedChannels.map((channel) => (
                  <div key={`${channel.channelType}-${channel.accountId}`} className="flex items-center justify-between rounded-xl bg-muted border p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="h-10 w-10 shrink-0 flex items-center justify-center text-foreground bg-primary/10 rounded-lg shadow-sm">
